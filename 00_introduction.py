...
# MAGIC
# MAGIC **Pyomo** lets you express linear-optimisation models in clear, algebraic Python syntax, so business rules translate directly into code. It connects to numerous commercial and open-source solvers, enabling rapid prototyping and seamless scaling.
# MAGIC
...
# MAGIC
# MAGIC * In `01_operational_data`, we generate a synthetic supply chain network along with corresponding operational data, and review the network's properties and data requirements.
